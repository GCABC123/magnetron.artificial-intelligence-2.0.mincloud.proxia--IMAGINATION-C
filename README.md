...
This is a Google Colab/Jupyter Notebook for developing an IMAGINATION proxia (that outputs video and images) when working with ARTIFICIAL INTELLIGENCE 2.0 ™ 
